...
export default {
  "template": {
        ...
        "remedy_addons": [
          {
            ...
            "hi": "अमेज़थ तनाव और स्पष्टता को बढ़ावा देता है।"
          },
          {
    ...
    "gemstone": {
      "Aries": {
        "gemstone": "Red Coral",
        "reason": "Wearing Red Coral can boost your confidence and energy."
      },
      "Taurus": {
        "gemstone": "Emerald",
        "reason": "Emerald can enhance your creativity and emotional balance."
      },
      "Gemini": {
        "gemstone": "Agate",
        "reason": "Agate promotes stability in your thoughts and decisions."
      },
      "Cancer": {
        "gemstone": "Moonstone",
        "reason": "Moonstone can enhance your intuition and emotional strength."
      },
      "Leo": {
        "gemstone": "Ruby",
        "reason": "Ruby is known to attract success and recognition."
      },
      "Virgo": {
        "gemstone": "Peridot",
        "reason": "Peridot helps in organizing your thoughts and tasks."
      },
      "Libra": {
        "gemstone": "Opal",
        "reason": "Opal can bring harmony and balance into your relationships."
      },
      "Scorpio": {
        "gemstone": "Bloodstone",
        "reason": "Bloodstone can boost your determination and resilience."
      },
      "Sagittarius": {
        "gemstone": "Turquoise",
        "reason": "Turquoise supports communication and adventure."
      },
      "Capricorn": {
        "gemstone": "Onyx",
        "reason": "Onyx enhances self-discipline and strength."
      },
      "Aquarius": {
        "gemstone": "Amethyst",
        "reason": "Amethyst fosters clarity and spiritual growth."
      },
      "Pisces": {
        "gemstone": "Aquamarine",
        "reason": "Aquamarine encourages peace and emotional healing."
      }
    },
    "mantra": {
      "Aries": {
        "mantra": "Om Angarakaya Namah",
        "reason": "This mantra can enhance your courage and assertiveness."
      },
      "Taurus": {
        "mantra": "Om Shukraya Namah",
        "reason": "Chanting this mantra attracts abundance and beauty."
      },
      "Gemini": {
        "mantra": "Om Budhaya Namah",
        "reason": "This mantra helps in gaining clarity in communication."
      },
      "Cancer": {
        "mantra": "Om Chandraya Namah",
        "reason": "Chanting this mantra enhances emotional well-being."
      },
      "Leo": {
        "mantra": "Om Surya Namah",
        "reason": "This mantra brings vitality and energy into your life."
      },
      "Virgo": {
        "mantra": "Om Rahave Namah",
        "reason": "Chanting this mantra enhances analytical skills."
      },
      "Libra": {
        "mantra": "Om Shantih",
        "reason": "This mantra promotes peace and harmony in relationships."
      },
      "Scorpio": {
        "mantra": "Om Kalabhairavaya Namah",
        "reason": "Chanting this mantra enhances determination and focus."
      },
      "Sagittarius": {
        "mantra": "Om Purnamadah",
        "reason": "This mantra encourages adventure and exploration."
      },
      "Capricorn": {
        "mantra": "Om Shani Namah",
        "reason": "This mantra fosters discipline and responsibility."
      },
      "Aquarius": {
        "mantra": "Om Vayu Namah",
        "reason": "Chanting this mantra enhances creativity and innovation."
      },
      "Pisces": {
        "mantra": "Om Varuna Namah",
        "reason": "This mantra encourages emotional healing and intuition."
      }
    }
  },
  "version": "2025-08"
